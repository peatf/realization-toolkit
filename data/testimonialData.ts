...
export const testimonials: Testimonial[] = [
  {
    text: "Started my work day with [the] Refiner tool and oh my god, this is sheer magic. You did your mf thing with this one Pea",
    name: "@marrmarrmarrr"
  },
  {
    text: "",
    name: "",
    imageUrl: "https://i.imgur.com/2MwWs0C.jpeg"
  },
  {
  ...
  {
    text: "I worked with the refiner and omg - I had the biggest realization about how my work, sexuality and friendship are connected to my income. I'm speechless. Things are unfolding for me in the biggest f way and I'm here for itttt!!! Thank you! Sooooo grateful!!",
    name: "Viviane"
  },
  {
  ...
  },
  {
    text: "",
    name: "",
    imageUrl: "https://i.imgur.com/JM4lyGx.jpeg"
  },
  {
    text: "Celebrating how open and aligned I've been feeling lately. This has manifested in moving my body more, getting out of the house more, connecting with others, being open more, and being willing to speak and externalize from my desired identity and reality. Celebrating not punishing myself as harshly for the moments when I don't do any of those things. I like where I'm at right now, and that's cool.",
    name: "R"
  },
  {
    text: "I want to share something I'm so proud of doing this morning; I called in sick today even though it was an art modeling job I love and enjoy doing genuinely (and I like the money too lol). I want to celebrate the fact that I'm finally choosing my well-being and health ABOVE money and the (awful) put-others-first-before-myself kind of responsibility I've always upheld when it comes to work, especially if I'm passionate about it. This action feels good, even if it's kind of new to me. But anyway, to celebrate, comfort and reward myself, I decided to take up the generous BF offer for the RTK membership! Heheheh. I am happy to be back again; I am committing to believing and relaxing for at least a month! P.S. Funnily enough another artist local in my area has just reached out to me out of the blue asking me to model, and is offering to pay more than the money I 'lost' from this morning! Lol life is wild.",
    name: "Lorraine"
  },
  {
  ...
  },
  {
    text: "",
    name: "",
    imageUrl: "https://i.imgur.com/nOH6RTd.jpeg"
  },
  {
    text: "I celebrate being in my own business without even dreaming about it, but just being there because I was doing what I like as a game and sharing it with family, and some people asked for that and it transformed into work by itself. Even though is the beginning, it proves things that I only dreamt about and that gives me confidence and magic. I celebrate my project and having people expecting it.",
    name: "Judit"
  },
  {
    text: "Making waves and moves in my life lately, and the refiner in particular has been such a good support! Just want to say how grateful I am for it and this big beautiful scary world! Feeling scatterbrained by good! Worth celebrating still!",
    name: "Lorraine"
  },
  {
    text: "I am just so excited and happy for the future y'all. My potential is like really impressive to me, in fact, I impress myself everyday. I am doing every single thing right and I have no doubt in my mind that great success awaits. I can't wait for all the adventures and experiences that are still awaiting. I feel like this is just the beginning for me.",
    name: "Shivi"
  },
  {
    text: "I'm new to the clurb, and have found that we are indeed all fam-there is such a coherence to this space that over the weekend I did not one, but both timeline jumps in the Power Tools Kit. It just felt right. I felt ready, and I knew the New Moon was bringing it all to me. My desire was to embody my most successful self. Not because I needed anything from her, necessarily, but because I wanted to get to know her better and let her drive for a change. For the first time since doing the timeline jumps (been in the practice for over a year), I actually felt myself meet ME. The self that I was hugging was ME. I've never felt it that personally before, it's always felt a bit external. But because of that shift, the way I feel, the words I say internally & externally, the choices I make, and how I respond to the world around me are different than before, but in no way does doing the new thing feel foreign. It feels warm and cozy and cheery, and also like I'm remembering something I've always done, not trying so hard to learn a new behavior. I feel like I've welcomed myself Home. Thanks Pea! Thanks friends!",
    name: "Sanpriti"
  },
  {
    text: "Hey hey hey. So fun to be in this spaceship with you all. From being in here and doing pea's work & just being myself… this year I have: 1) had the most successful launch so far 2) found an assistant I truly love and am supported by 3) raised by rates with total ease and comfort 4) been more consistently inspired 5) have allowed myself to rest 6)have been choosing fun, easy and fulfilling over my intellect's love of complexity 7) have been meeting the most exciting, genius, creative clients who are all universe's in themselves 8) allowed myself to change up how and what I do whenever I want and have been supported all the way through 9) received a wild influx of podcast invitations that were super fun and easy. YAY to my big ass money plant that keeps growing. All the random intuitive investments I made that have all grown this year. My cute cat. My sweet office. My new computer, and spacious time and schedule to just re-lax and en-JOY. Thank you pea and thank you juicy artistic peers!",
    name: "Xenia"
  },
  {
    text: "Indulging in the sense of safety no matter what. Taking a nap when it feels right, leisuring in sweatpants and matching sweater all day. Getting a disney+ account bc it inspires me. Great cannabis moment w bf, laughter, deep talk, great sex, dancing at the supermarket to where is the love by black eyed peas. Buying glass pearls/marbles and colourful glue sticks just for fun and decorating the candle holders w the marbles. Making instagram stories just for fund and how it comes to me feeling a little cringe but doing it anyways. Doing less \"productive stuff\". Taking a long walk without phone in the forest and admiring the beauty of the moss, the trees, the light, the greens. Drinking two milky coffees bc I like it. Not making dinner bc I don't feel like it. Trusting my needs more and more.",
    name: "Norene"
  },
  {
    text: "If you've never worked with [Pea] before and you're curious, consider this your sign. They hold such a strong vibe of neutrality that I haven't felt in many spaces other than my own (but that is changing!!). Grateful grateful grateful. P.S. change/shift/growth doesn't have to feel unstable/unsafe/illogical. In fact, if it does, chances are that new way won't stick around very long. Speaking from 42 years & 8 months of experience.",
    name: "@Sanpritilife"
  },
  {
    text: "Noticing my relationship to tension is changing so much from panic/struggle to gratitude for pointing me toward what I do want, and it's taking less and less conscious energy to redirect myself. Really is boosting the quality of my days!",
    name: "Molly"
  },
  {
    text: "Appreciating the sensation of wholeness as something i've known in my mind for a while drops down into my body as wisdom… aah. The moment when mind + body + heart finally agree is like finding a clear frequency sans static. I'd been feeling tension the past 3 weeks over a fear of repeating tired old patterns this winter season & wanting to change a bit of my sales process to make it easier & allow me more rest this season. This brought up guilt, feelings of inadequacy/\"not-enoughness,\" judgements of being lazy, and fear of failure. This showed up as tightness on my neck shoulders and upper back. I see my mind consumed with figuring out a guarantee, my body getting stressed, and my heart just wanting to take it a day at a time. Yesterday I decided I no longer want to use my mind to metabolize this tension so I got a targeted upper body massage. Eight hours of sleep later, it clicked: The version of me that I've been wanting isn't figuring out sufficiency this winter because she already has it. It's automatically given no matter the state of my energy, whether it's high or low. There are customers for every level I'm willing and able to give. Pea says this, I knew it in my mind, but today my body and heart aligned and accepted it as truth. I also got some material proof by the way of 2 new bookings using the easier sales process. :-) Now, instead of prayers to move bookings my way (with a bit of a desperate energy in hindsight), I am writing a note of thanks for what's here, which is truly more than enough.",
    name: "CH"
  },
  {
    text: "",
    name: "",
    imageUrl: "https://i.imgur.com/eT2DZAR.jpeg"
  },
  {
    text: "I released some shame around a desire of mine and clarified what people I want to connect with. I just got offered an opportunity that 100% aligns with what I want to create.",
    name: "Mani"
  },
  {
  ...
  {
    text: "I celebrate the nice morning w coffee and an old friend visiting. Talking about writing and art. And then I celebrate last nights writing urge, six texts in one setting and no sleep until 3 am, but feeling calm about it, telling my body its safe and believing it, acknowledging the threats and the angst but giving it the balm of authority and agency. I celebrate following the inspiration to make a little winter popup in instagram w my printed shirts and selling almost everything in 1.5 days after asking for money portals. Celebrating a friend who called a day to tell me he joins us for new years eve in the mountains, celebrating myself for being able to organize a thing w 8 people for five days in the alps for the start of a new year. A sensation in my body that grows and magnifies everyday of trust and everything is going to be alright, you're safe, you're enough. Celebrating peas podcast episode w alejandra smits and being expanded by her way of writing. Sensing that if thats good my writing is good, too. And worth to share and express.",
    name: "Norene"
  },
  {
    text: "I feel the most stable and trusting I have ever felt. I know that not only can I handle whatever comes my way but that I am skilled in creating the momentum I desire. Last night I hosted the most successful event I've done solo. I didn't just want ticket sales… I wanted to attract the people that fit into the energy of how I want to host… and last night I got just that. I felt true and real and satisfied while participants went on a deep journey. It was so great.",
    name: "Andrea"
  },
  {
    text: "During our RTK call yesterday, a desire surfaced and articulated itself very bluntly. It was very liberating to embrace this desire with little-to-none shame or blame and I celebrate that it appeared in a very direct, clear communication. I look forward to specifically taking actions on behalf of my business aspect (naming this aspect \"babar\" lol); today I will be writing up a pretty thrilling invoice that may be for the largest amount of my life so far? That's the type of thing that will make my business aspect feel supported. Now I will be drinking tea and animating on this snowy day…",
    name: "e"
  },
  {
    text: "Today I finished the manuscript for my second book. It feels magical and also like something I am probably going to do again because the identity of writer is starting to grow on me. The pictures taken for the book are absolutely marvelous. Like they should be shown in an exhibition by themselves.",
    name: "Mani"
  },
  {
    text: "Well done on the amplification ritual Pea, that was a trip! I feel amplified and really enjoyed the throwback theme. I felt like a kid playing computer games on MS-DOS.",
    name: "Andrea"
  },
  {
  ...
  },
  {
    text: "",
    name: "",
    imageUrl: "https://i.imgur.com/CrdpyRj.jpeg"
  }
];